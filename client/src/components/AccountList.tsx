...
const AccountList = ({ accounts, onDisconnect }: AccountListProps) => {
    ...
    if(accounts.length === 0){
        ...
        flex flex-col items-center justify-center py-20 px-6">
            <div className="size-14 bg-slate-20 rounded-2xl flex items-center justify-center
            mb-4 border border-slate-100">
        ...
        {accounts.map((account, index)=>{
            ...
            return (
                <div key={index} className="group bg-white border
                 border-slate-200 rounded-2xl p-5 flex items-center gap-4
